...
const AddItem = ({setShowAddDetails,setSelectedCategory,category}) => {
  return (
    <div 
      onClick={() => {setShowAddDetails(true);setSelectedCategory(category)}}
    ...
    >
      ...
      <p className="text-blue-700 font-medium text-lg">Add More</p>
    </div>
  );
};
